...
#define LIGHT_I2C_OPENCORES_BASE    NIOS_SENSOR_SYSTEM_LIGHT_I2C_OPENCORES_BASE
#define MPU_I2C_OPENCORES_BASE      NIOS_SENSOR_SYSTEM_MPU_I2C_OPENCORES_BASE
#define RH_TEMP_I2C_OPENCORES_BASE  NIOS_SENSOR_SYSTEM_RH_TEMP_I2C_OPENCORES_BASE
#define RH_TEMP_DRDY_N_BASE         NIOS_SENSOR_SYSTEM_RH_TEMP_DRDY_N_BASE
#define SYSTEM_SHARED_MEMORY_BASE   NIOS_SENSOR_SYSTEM_SHARED_MEMORY_BASE
